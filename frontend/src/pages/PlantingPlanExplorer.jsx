  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="bg-gradient-to-r from-purple-600 to-violet-700 rounded-xl p-8 mb-8 shadow-lg">
        <h1 className="text-3xl font-bold text-white mb-4">Learning Plans Explorer</h1>
        ...
        <div className="flex flex-col md:flex-row gap-4">
          ...
          {isAuthenticated && currentUser?.role === "admin" && (
            ...
            >
              <FaRegLightbulb className="mr-2" /> Create New Plan
            </Link>
          )}
        </div>
      </div>
      ...
      >
        {getFilteredPlans().length > 0 ? (
                ...
                <div className="p-6">
                  ...
                  <div className="flex items-center justify-between text-sm text-gray-500 mb-4">
                    ...
                    <div className="flex items-center">
                      ...
                      <span>{plan.usersFollowing?.length || 0} learners</span>
                    </div>
                  </div>
          ...
          <div className="col-span-full py-16 text-center">
            ...
            <h3 className="text-xl font-medium text-gray-600 mb-2">No learning plans found</h3>
