...
function Navbar() {
    ...
    const handleMouseEnter = () => {
      ...
      for (let i = 0; i < 8; i++) {
        newParticles.push({
          ...
          color: ['#FFC837', '#FF8008', '#F976FF', '#B721FF'][Math.floor(Math.random() * 4)],
  ...
  return (
    <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${
      scrolled 
        ? 'bg-white/80 backdrop-blur-lg text-purple-800 shadow-lg' 
        ...
        <div className="flex justify-between h-16">
          ...
          <div className="hidden sm:flex sm:items-center sm:justify-between sm:flex-1 ml-6">
            <div className="flex space-x-2">
              <Link className={`group px-3 py-2 rounded-md text-sm font-medium transition-all duration-300
                ${scrolled 
              ...
              <Link className={`group relative px-3 py-2 rounded-md text-sm font-medium transition-all duration-300
                ${scrolled 
            ...
            <div className="flex items-center">
              {currentUser ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  {showDropdown && (
                    <div className="origin-top-right absolute right-0 mt-2 w-56 rounded-xl shadow-xl 
                      ...
                      <div className="py-3 px-4 border-b border-gray-100">
                        ...
                        <p className="text-sm font-bold text-purple-700 truncate">{currentUser?.email || currentUser?.username}</p>
                      </div>
                      <div className="py-1">
                        <Link 
                          to="/profile" 
      ...
      {navbarOpen && (
        <div className="sm:hidden bg-white/95 backdrop-blur-lg shadow-lg rounded-b-xl animate-slideDown" id="mobile-menu">
